...
public class ViewOrderDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String maHoaDon_raw = request.getParameter("mahoadon");
        ...
        if (a == null) {
            ...
            try {
                int maHoaDon = Integer.parseInt(maHoaDon_raw);
                HoaDonDAO hddao = new HoaDonDAO();
                List<HoaDonChiTiet> list = hddao.getOrderDetailByMaTaiKhoanAndMaHoaDon(a.getMaTaiKhoan(), maHoaDon);
