...
public class ChartServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Integer> list2 = dtdao.listSaleByTime(list1);
        request.setAttribute("listdoanhthu", list2);
        
        TheLoaiDAO tldao = new TheLoaiDAO();
        List<TheLoai> list3 = tldao.getAllTheLoai();
        List<Integer> list4 = dtdao.soLuongBanTheoTheLoai();
        request.setAttribute("listtheloai", list3);
        request.setAttribute("listluotban", list4);
