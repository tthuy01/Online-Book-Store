...
public class UpdateInformationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String maTaiKhoan_raw = request.getParameter("mataikhoan");
        try {
            int maTaiKhoan = Integer.parseInt(maTaiKhoan_raw);
            TaiKhoanDAO tkdao = new TaiKhoanDAO();
            TaiKhoan a = tkdao.getAccountById(maTaiKhoan);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        TaiKhoan a1 = new TaiKhoan(a.getMaTaiKhoan(), name, gender, date, phone, email, address, a.getTenDangNhap(), a.getMatKhau(), a.getMaPhanQuyen());
        TaiKhoanDAO tkdao = new TaiKhoanDAO();
        tkdao.updateInformation(a1);
        response.sendRedirect("profile?tendangnhap="+a.getTenDangNhap());
    }
