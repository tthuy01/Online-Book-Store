<%-- 
    Document   : profile
    Created on : Mar 12, 2022, 11:19:53 PM
    ...
    <body style="background-color: orange">
        <div class="container">
            ...
            <div class="content" style="display: flex;">
                ...
                <div class="profile" style="color: white; width: 40%; margin: 0 auto; padding: 2% 2%; flex-grow: 3;">
                    <div class="view-content" style="width: 80%; margin: 0 auto; background-color: black; padding: 2% 5%; font-size: 20px;">
                        <c:set var="p" value="${requestScope.profile}"></c:set>
                        <p>Tên: ${p.ten}</p>
                        <p>
                            Giới tính: 
                            <c:if test="${p.gioiTinh == false}">
                                <img src="images/male-icon.png">
                            </c:if>
                            <c:if test="${p.gioiTinh == true}">
                                <img src="images/female-icon.png">
                            </c:if>
                        </p>
                        <p>Ngày sinh: ${p.ngaySinh}</p>
                        <p>Số điện thoại: ${p.SDT}</p>
                        <p>Email: ${p.email}</p>
                        <p>Địa chỉ: ${p.diaChi}</p>
                        <p>Phân quyền: ${p.phanQuyen.tenQuyen}</p>
                    </div>
                </div>
            </div>
