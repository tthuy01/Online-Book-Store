<%-- 
    ...
    Created on : Mar 6, 2022, 12:45:46 AM
...
<html>
    ...
    <body>
        ...
        <form class="add-author-form" action="publisher">
            <h1>Thêm nhà xuất bản</h1>
            <h3 style="color: red; text-align: center">${requestScope.error}</h3>
            <input type="text" name="id" placeholder="Mã NXB">
            <input type="text" name="name" placeholder="Tên NXB">
