<%-- 
    Document   : vieworder
    Created on : Mar 16, 2022, 10:59:50 PM
        ...
        <div class="container">
            ...
            <div class="content" style="display: flex;">
                <div class="menu-profile" style="flex-grow: 2; color: white; padding: 2% 2%; margin-top: 2%;">
                    <c:if test="${sessionScope.account.maPhanQuyen == 0}"> 
                        <a href="profile?tendangnhap=${sessionScope.account.tenDangNhap}">Thông tin khách hàng</a> <br/><br/><br/>
                        <a href="vieworder" style="background-color: #4CAF50; border: 2px solid #4CAF50;">Đơn hàng đã đặt</a> <br/><br/><br/>
                ...
                <div class="profile" style="color: white; width: 70%; margin: 0 auto; padding: 2% 2%; flex-grow: 3;">
                    <div class="view-content" style="width: 100%; margin: 0 auto; background-color: black; padding: 2% 5%; font-size: 20px;">
                        <table border="1px" style="margin: 0 auto;">
                            ...
                            <c:forEach items="${requestScope.allhoadonbymataikhoan}" var="i">
                                <c:set var="stt" value="${stt + 1}"></c:set>
                                    ...
                                    <td>${i.diaChiShip}</td>
                                    <td>${i.ngayDatHang}</td>
                                    <td><a href="vieworderdetail?mahoadon=${i.maHoaDon}">Chi tiết</a></td>
                                </tr>
                            </c:forEach>
                        </table>
                    </div>
